  ...
  return (
    <footer style={{ borderTop: '1px solid var(--card-border)', padding: '40px 0', marginTop: '60px', background: 'var(--bg-color)' }}>
      <div className="container flex justify-between items-center md-flex-col gap-4">
        <div style={{ display: 'flex', alignItems: 'center', gap: '4px', fontSize: '20px', fontWeight: 800 }}>
          <img src="/logo-black.png" alt="A4DEV Logo" style={{ width: '32px', height: '32px', borderRadius: '6px', objectFit: 'cover' }} />
          <div>
